...
async function POST(req) {
    try {
        ...
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prompts$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isToyKey"])(toy) || !Array.isArray(messages) || messages.length === 0) {
        ...
        const guard = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$guard$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["checkInput"])(lastUserText(messages));
        if (!guard.ok) {
            return Response.json({
                error: "guard",
                reason: guard.reason
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1gpm0zq._.js.map